...
# Дерево решений - регрессия (предсказание - спуск по дереву)
class MyTreeReg():
...
if __name__ == '__main__':
    ...
    #myTreeReg = MyTreeReg(max_depth=1, min_samples_split=1, max_leafs=2)
    #myTreeReg = MyTreeReg(max_depth=3, min_samples_split=2, max_leafs=5)
    #myTreeReg = MyTreeReg(max_depth=5, min_samples_split=100, max_leafs=10)
    #myTreeReg = MyTreeReg(max_depth=4, min_samples_split=50, max_leafs=17)
    #myTreeReg = MyTreeReg(max_depth=10, min_samples_split=40, max_leafs=21)
    myTreeReg = MyTreeReg(max_depth=15, min_samples_split=35, max_leafs=30)
    #myTreeReg = MyTreeReg(max_depth=3, min_samples_split=2, max_leafs=1)
