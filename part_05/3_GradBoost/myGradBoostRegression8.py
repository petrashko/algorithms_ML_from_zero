...
# Градиентный бустинг - регрессия (регуляризация: штрафы за большое кол-во листьев в лесу)
class MyBoostReg():
    ...
    #     default=0.1
    # reg: Штраф за общее кол-во листьев в лесу. Принимает значения
    #      от 0.0 до бесконечности. default=0.1
    ...
    def __init__(self, n_estimators=10, max_features=0.5, max_samples=0.5,
                 ...
                 loss='MSE', metric=None, reg=0.1, learning_rate=0.1,
                 random_state=42):
    ...
    def replaceTargetInLeafs(self, tree, y_target, y_predict):
        ...
        for leaf in tree.leafList:
            ...
            # Штраф за общее кол-во листьев в лесу
            newTarget += self.leafs_cnt * self.reg
...
if __name__ == '__main__':
    ...
    myBoostReg = MyBoostReg(n_estimators=20, max_features=0.95, max_samples=0.95,
                max_depth=5, min_samples_split=2, max_leafs=40, bins=16,
                loss='MSE', metric='RMSE', reg=0.1,
