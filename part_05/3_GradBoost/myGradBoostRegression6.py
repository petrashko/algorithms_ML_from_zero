...
# Градиентный бустинг - регрессия (стохастический градиентный бустинг)
class MyBoostReg():
    ...
    def fit(self, X, y, verbose=False):
        ...
        for k in np.arange(0, self.n_estimators):
            ...
            y_predictTotal = y_predictTotal + (self.learningRate * y_predictForTree)
...
if __name__ == '__main__':
    ...
    myBoostReg = MyBoostReg(n_estimators=100, max_features=0.5, max_samples=0.5,
                max_depth=5, min_samples_split=2, max_leafs=40, bins=16,
                loss='MSE', metric='RMSE', learning_rate=0.5, random_state=42)
    #print(myBoostReg)
