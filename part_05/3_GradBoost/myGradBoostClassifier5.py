...
# Градиентный бустинг - классификация (стохастический градиентный бустинг)
...
class MyBoostClf():
    ...
    def fit(self, X, y, verbose=False):
        ...
        for k in np.arange(0, self.n_estimators):
            ...
            y_oddsTotal = y_oddsTotal + (self.learningRate * y_oddsForTree)
...
if __name__ == '__main__':
    ...
    myBoostClf = MyBoostClf(n_estimators=10, max_features=0.9, max_samples=0.9,
                            ...
                            metric='accuracy', learning_rate=0.5, random_state=42)
    #print(myBoostClf)
