...
# Градиентный бустинг - классификация (регуляризация: штрафы за большое кол-во листьев в лесу)
...
class MyBoostClf():
    ...
    def __init__(self, n_estimators=10, max_features=0.5, max_samples=0.5,
                 ...
                 metric=None, reg=0.1, learning_rate=0.1, random_state=42):
...
if __name__ == '__main__':
    ...
    myBoostClf = MyBoostClf(n_estimators=10, max_features=0.9, max_samples=0.9,
                            ...
                            metric='accuracy', reg=0.02, learning_rate=0.5, random_state=42)
    #print(myBoostClf)
